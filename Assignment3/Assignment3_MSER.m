...
% Load images.
Dir = fullfile('C:\Users\user\Documents\MATLAB\Sharanya\project_3\images');
...
plot(points,'showPixelList',true,'showEllipses',false);
hold off;
...
a = (2*size(Scene.Files,1)-2);
matchedPoints = cell(32,a);
for i = (size(Scene.Files,1)):-1:2
    I1 = readimage(Scene, i);
    grayImage1 = rgb2gray(I1);
    I2 = readimage(Scene, i-1);
    ...
    matchedPoints{i + (i-1)} = matchedPoints1;
    matchedPoints{2*i} = matchedPoints2;
    
    figure;
    showMatchedFeatures(I1, I2, matchedPoints1, matchedPoints2);
    legend(['matched points in I' num2str(i)],['matched points in I' num2str(i-1)]);
end

%% Taking Photographs
path='C:\Users\Stephen\Dropbox\MATLAB\Computer Vision and Image Reconstruction\Assignment3\images\'
img1 = im2double(rgb2gray(imread([path 'img_0.jpg'])));
img2 = im2double(rgb2gray(imread([path 'img_1.jpg'])));
